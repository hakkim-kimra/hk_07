...
$goal_query = $conn->query("SELECT SUM(target_amount) as t FROM goals WHERE user_email='$email'");
$total_goals = $goal_query->fetch_assoc()['t'] ?? 0;
...
$free_to_spend = $remaining - $total_goals;

$days_in_month = date("t");
$days_passed = max(1, date("j"));
$days_left = $days_in_month - $days_passed;
$daily_limit = ($days_left > 0) ? ($free_to_spend / $days_left) : 0;
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Professional Active Link Indicator */
